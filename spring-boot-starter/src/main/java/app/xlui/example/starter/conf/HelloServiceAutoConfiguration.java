package app.xlui.example.starter.conf;

import app.xlui.example.starter.property.HelloServiceProperties;
import app.xlui.example.starter.service.HelloService;
